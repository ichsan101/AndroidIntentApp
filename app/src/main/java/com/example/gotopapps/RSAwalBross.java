    ...
    private void tampilkanpilihan(String pilihan) {
        try{
            ...
            if(pilihan.equals("Call Center")){
                String nomortlp = "tel:0895618256591";
                a = new Intent(Intent.ACTION_DIAL, Uri.parse(nomortlp));


            }else if(pilihan.equals("SMS Center")){
            String smsText = "Muhammad Ichsan H/L";
            a = new Intent(Intent.ACTION_VIEW);
            a.setData(Uri.parse("sms:0895618256581"));
